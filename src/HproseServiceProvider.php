...
namespace pkg6\laravel\Hprose;

use Illuminate\Support\ServiceProvider;
use pkg6\laravel\Hprose\Clients\SocketClient;
use pkg6\laravel\Hprose\Commands\SocketCommand;
use pkg6\laravel\Hprose\Routing\Router;
use pkg6\laravel\Hprose\Servers\SocketServer;
use stdClass;
    ...
    public function boot()
    {
        ...
        if (config('hprose.server.http.enable', false)) {
            $this->app->router->group([
                ...
                'namespace' => '\\pkg6\\laravel\\Hprose\\Http\\Controller'
            ], function ($router) {
